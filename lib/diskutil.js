...
const transform = (disk) => {
  ...
  return {
    ...
    logicalBlockSize: disk.DeviceBlockSize,
    mountpoints: [],
...
const setMountpoints = (devices, list) => {
  devices.forEach((device) => {
    ...
    const partitions = layout.Partitions ? layout.Partitions.concat(layout.APFSVolumes || []) : [];
    device.mountpoints = partitions.filter((part) => {
...
module.exports = { list, transform, setMountpoints };
